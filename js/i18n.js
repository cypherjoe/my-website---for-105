(function () {
    ...
    var T = {
        en: {
            ...
            'lawasia.body': 'I was one of the three Oralists on the team. I was responsible for Issue 3&4 of the case, tackling proximate cause arguments and injunction/damages/standing issues. I drafted two 40-page legal memos for simulated international arbitration cases. I also collected industry-specific data (e.g., bioenergy production processes, pollution control standards). During the Moot, I delivered six 20-minute oral presentations, handled challenging questions from active judges and partners, and gave real-time rebuttals to opposing counsel. Eventually, our team won fourth place and was awarded the “Best Endeavor Prize.”',
            ...
            'translator.p2': 'During my internship at JS Law, I was responsible for translating our client’s Stock Keeping Unit (SKU) descriptions, scrutinizing them to compare them with registered Intellectual Properties (IPs), before assisting with motion drafting. Further, I served as a simultaneous translator for the CEO of Maidalyu (the AI Temporary Restraining Order platform) and a Partner of JS Law during business meetings and livestreaming events.',
            ...
            'studentCoach.body3': 'Starting in April 2026, leveraging my past mentoring experience, I will be in a new position at Peer Med, a student organization focused on pre-med mentorship at UNC-Chapel Hill, under the supervision of Dr. Bradley Hammer. I am responsible for preparing pre-law/pre-professional/pre-policy track students and Chinese international students to thrive in a top-tier American institution.',
        ...
        zh: {
            ...
            'lawFirms.body': '作为法律实习生，我在跨境诉讼与全球交易两方面都打下了扎实基础。在 JS Law，我负责电商诉讼防御，协调超过 60 名客户的尽职调查，帮助在广州与深圳合计取得超过人民币 300 万元的和解，同时依据美国法院动态每日推送 Temporary Restraining Order（TRO）预警以管控跨境风险。',
            'lawFirms.body2': '随后我转入 Freshfields LLP 全球交易部 Equity Capital Market 团队，参与七项大型 IPO 项目：开展逾 30 场现场第三方尽职调查访谈，翻译逾 20 份复杂监管文件，并以英文撰写逾 10 章美国侧招股书内容，展现了在复杂多法域环境中工作的能力。',
            ...
            'lawasia.body': '我在团队中担任三位 Oralists 之一，负责案件第 3 与第 4 项争议，重点处理近因（proximate cause）论证，以及禁令/损害赔偿/诉讼资格等问题。我为模拟国际仲裁案件撰写了两份约 40 页的法律备忘录，并收集行业专项资料（如生物能源生产流程、污染控制标准）。在比赛期间，我完成了六场约 20 分钟的口头陈述，回应评委法官与律所合伙人的高强度提问，并对对方律师进行实时反驳。最终，我们团队获得第四名，并获颁“Best Endeavor Prize”。',
            'translator.p1': '在学勤书院担任学生译者期间，我负责校内最紧急、最重要文件的校对、修改与翻译工作，其中包括年度高桌晚宴主旨演讲嘉宾的幻灯片。在为书院持续贡献的三年中，我累计完成 30 余项笔译工作与 5 余次同声传译需求。',
            'translator.p2': '在 JS Law 实习期间，我负责翻译客户的商品简介，并将其与已注册的知识产权逐项比对审查，随后协助起草动议文件。此外，我还在商务会议与直播活动中担任同声传译，为“卖大律”（AI TRO预警平台）首席执行官与 JS Law 合伙人提供中英口译支持。',
            ...
            'englishTeaching.body2': '自 2026 年 3 月起，我被任命为 Stepping Stone China 的独立授课老师。该公益组织致力于为中国欠发达地区儿童提供高质量英语教育。目前，我为来自福建南安的 22 名五年级中国学生教授英语（重点训练口语与词汇）。',
            ...
            'studentCoach.body3': '自 2026 年 4 月起，基于过往导师经验，我将在 UNC-Chapel Hill 的 Peer Med 开启新岗位，并在 Dr. Bradley Hammer 指导下开展工作。该组织专注于 pre-med 导师辅导；我将负责帮助 pre-law/pre-professional/pre-policy 方向学生以及中国国际学生在美国顶尖高校中实现更好发展。',
